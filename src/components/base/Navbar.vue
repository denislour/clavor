<template>
    ...
    >
        ...
        <div class="flex-none w-56 flex flex-row items-center">
            <img src="src/assets/img/logo.png" class="w-10 flex-none" />
